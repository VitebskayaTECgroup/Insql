...
select
	...
	null, 
	CAST(U07_UM11G001_H1 as decimal(15,2)) as "M ПСВ за п/с, т/cут [hint: масса теплоносителя по подающим трубопроводам (счетчик)]",
	CAST(U07_UM11P001_H1 as decimal(15,2)) as "P ПСВ за п/с, абс.МПа [U07_UM11P001_H1]",
	CAST(U07_UM11T001_H1 as decimal(15,2)) as "T ПСВ за п/с, °С [U07_UM11T001_H1]",
	CAST(U07_UM11T001_H1 as decimal(15,2)) as "Tср.взв. ПСВ за п/с, °С [hint: Средневзвешенная температура прямой СВ за п/с]",
	CAST(U07_UM21G001_H1 as decimal(15,2)) as "M ОСВ за п/с, т/cут [hint: масса теплоносителя по обратным трубопроводам (счетчик)]",
	CAST(U07_UM21P001_H1 as decimal(15,2)) as "P ОСВ за п/с, абс.МПа [U07_UM21P001_H1]",
	CAST(U07_UM21T001_H1 as decimal(15,2)) as "T ОСВ за п/с, °С [U07_UM21T001_H1]",
	CAST(U07_UM21T001_H1 as decimal(15,2)) as "Tср.взв. ОСВ за п/с, °С [hint: Средневзвешенная температура обратной СВ за п/с]",

	CAST(U07_UM11W001_H1 as decimal(15,2)) as "Q ПСВ за п/с, ГДж [hint: Отпущенная теплоэнергия по подающему трубопроводу (счетчик)]",
	CAST(U07_UM21W001_H1 as decimal(15,2)) as "Q ОСВ за п/с, ГДж [hint: Возвращенная теплоэнергия по обратному трубопроводу (счетчик)]",
	CAST(U07_UM31W001_H1 as decimal(15,2)) as "dQ по МАГ за п/с, ГДж [hint: Потребленная теплоэнергия (счетчик)]",
	CAST(U07_VB00T001 as decimal(15,2)) as "Tхв за п/с, °С [U07_VB00T001]",

	MkorrPr as "кор Mсум ПСВ, тонн [hint: Масса теплоносителя по подающему трубопроводу скорректир]",
	MkorrObr as "кор Mсум ОСВ, тонн [hint: Масса теплоносителя по обратному трубопроводу скорректир]",
	MPodpKorr as "кор Mсум подп, тонн [hint: Масса теплоносителя на подпитку скорректир]",
	cast(MEnergPr/1000 as decimal(15,2)) as "кор Qсум ПСВ, ГДж[hint:Отпущенная теплоэнергия по подающим трубопроводам скоррект]",
	cast(MEnergObr/1000 as decimal(15,2)) as "кор Qсум ОСВ, ГДж[hint: Отпущенная теплоэнергия по обратным трубопроводам скоррект]",
	cast(MEnergPodp/1000 as decimal(15,2)) as "кор Qсум подп, ГДж[hint: Отпущенная теплоэнергия с подпиткой скоррект]",
	MEnergItog as "кор dQсум,ГДж [hint: Суммарная потребленная теплоэнергия по магистралям скоррект]",
	cast(MEnergItog/4.187 as decimal(15,0)) as "кор dQсум,Гкал [hint: Суммарная потребленная теплоэнергия по магистралям скоррект]"
from
(
select 
...
U07_UM11P001_H1,U07_UM21P001_H1
...
AND DateTime >= @start
AND DateTime <= @finish
AND wwResolution = @resolution AND wwResolution = @resolution ") r
) t
) as N
...
select
	...
	null, 
	CAST(U07_UM11G001_S1 as decimal(15,2)) as "M ПСВ за п/с, т/cут [hint: масса теплоносителя по подающим трубопроводам (счетчик)]",
	...
	CAST(U07_UM11T002_S1 as decimal(15,2)) as "Tср.взв. ПСВ за п/с, °С [hint: Средневзвешенная температура прямой СВ за п/с]",


	CAST(U07_UM21G001_S1 as decimal(15,2)) as "M ОСВ за п/с, т/cут [hint: масса теплоносителя по обратным трубопроводам (счетчик)]",
	...
	CAST(U07_UM21T002_S1 as decimal(15,2)) as "Tср.взв. ОСВ за п/с, °С [hint: Средневзвешенная температура обратной СВ за п/с]",

	CAST(U07_UM11W001_S1 as decimal(15,2)) as "Q ПСВ за п/с, ГДж [hint: Отпущенная теплоэнергия по подающему трубопроводу (счетчик)]",
	CAST(U07_UM21W001_S1 as decimal(15,2)) as "Q ОСВ за п/с, ГДж [hint: Возвращенная теплоэнергия по обратному трубопроводу (счетчик)]",
	CAST(U07_UM31W001_S1 as decimal(15,2)) as "dQ по МАГ за п/с, ГДж [hint: Потребленная теплоэнергия (счетчик)]",
...
cast(U07_UM11P001_S1 as decimal (15,2)) as U07_UM11P001_S1,
cast(U07_UM21P001_S1 as decimal (15,2)) as U07_UM21P001_S1,
...
U07_UM11P001_S1,U07_UM21P001_S1
FROM Runtime.dbo.AnalogWideHistory 
WHERE wwVersion = 'LATEST'
AND wwRetrievalMode = 'Cyclic'
AND wwResolution = @resolution
AND DateTime >= @start
AND DateTime <= @finish
AND wwResolution = 86400000 AND wwResolution = 86400000 ") r
) t
) as N