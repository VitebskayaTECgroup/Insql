...
SELECT
	...
	null,
	CAST(U07_UM11G001_H1 / 10 as decimal(15,0)) as "G ПСВ за п/ч, т/ч [U07_UM11G001_H1]",
	CAST((U07_UM11G001_H1 / 10)*dbo.vst_SafeDIV(U00_UM10F702_H1,U00_UM10F701_H1) as decimal(15,0)) as "корр G ПСВ за п/ч, т/ч",
	...
	CAST(U07_UM21G001_H1 / 10 as decimal(15,0)) as "G ОСВ за п/ч, т/ч [U07_UM21G001_H1]",
	CAST((U07_UM21G001_H1 / 10)*dbo.vst_SafeDIV(U00_UM20F702_H1,U00_UM20F701_H1) as decimal(15,0)) as "корр G ОСВ за п/ч, т/ч",
