...
select
	...
	null,
	CAST(U08_UM11F001_H1 as decimal(15,2)) as "M ПСВ за п/с, т/cут [hint:  масса  теплоносителя по подающим  трубопроводам (счетчик)]",
	CAST(U08_UM11P001_H1 as decimal(15,2)) as "P ПСВ за п/с, абс.МПа [U08_UM11P001_H1]",
	CAST(U08_UM11T001_H1 as decimal(15,2)) as "T ПСВ за п/с, °С [U08_UM11T001_H1]",
	/*CAST(U08_UM11T001_H1 as decimal(15,2)) as "Tср.взв. ПСВ за п/с, °С [hint: Средневзвешенная температура прямой СВ за п/с]",*/

	CAST(U08_UM21F001_H1 as decimal(15,2)) as "M ОСВ за п/с, т/cут [hint:  масса теплоносителя по обратным трубопроводам (счетчик)]",
	CAST(U08_UM21P001_H1 as decimal(15,2)) as "P ОСВ за п/с, абс.МПа [U08_UM21P001_H1]",
	CAST(U08_UM21T001_H1 as decimal(15,2)) as "T ОСВ за п/с, °С [U08_UM21T001_H1]",
	/*CAST(U08_UM21T001_H1 as decimal(15,2)) as "Tср.взв. ОСВ за п/с, °С [hint: Средневзвешенная температура обратной СВ за п/с]",*/
	/*U08_VB00T001,*/

	CAST(U08_UM11W001_H1 as decimal(15,2)) as "Q ПСВ за п/с, ГДж [hint: Отпущенная  теплоэнергия по подающему трубопроводу (счетчик)]",
	CAST(U08_UM21W001_H1 as decimal(15,2)) as "Q ОСВ за п/с, ГДж [hint: Возвращенная теплоэнергия по обратному трубопроводу (счетчик)]",
	CAST(U08_UM31W001_H1 as decimal(15,2)) as "dQ по МАГ за п/с, ГДж [hint: Потребленная теплоэнергия  (счетчик)]",
	CAST(U08_VB00T001 as decimal(15,2)) as "Tхв за п/с, °С [U08_VB00T001]",
LkorrPr as "кор Mсум ПСВ, тонн [hint: Масса теплоносителя по подающему трубопроводу скорректир]",
LkorrObr as "кор Mсум ОСВ, тонн [hint: Масса теплоносителя по обратному трубопроводу скорректир]",
LPodpKorr as "кор Mсум подп, тонн [hint: Масса теплоносителя на подпитку скорректир]",
cast(LEnergPr/1000 as decimal(15,2)) as "кор Qсум ПСВ, ГДж[hint:Отпущенная  теплоэнергия по подающим трубопроводам скоррект]",
cast(LEnergObr/1000 as decimal(15,2)) as "кор Qсум ОСВ, ГДж[hint:Отпущенная  теплоэнергия по обратным трубопроводам скоррект]",
cast(LEnergPodp/1000 as decimal(15,2)) as "кор Qсум подп, ГДж[hint: Отпущенная теплоэнергия с подпиткой скоррект]",
LEnergItog as "кор dQсум,ГДж [hint: Суммарная потребленная теплоэнергия по магистралям скоррект]",
cast(LEnergItog/4.187 as decimal(15,0)) as "кор dQсум,Гкал [hint: Суммарная потребленная теплоэнергия по магистралям скоррект]"
from
(
select 
/**/t.*,
...
select
	...
	null, 
	CAST(U08_UM11F001_S1 as decimal(15,2)) as "M ПСВ за п/с, т/cут [hint: масса теплоносителя по подающим трубопроводам (счетчик)]",
	...
	/*CAST(U08_UM11T002_S1 as decimal(15,2)) as "Tср.взв. ПСВ за п/с, °С [hint: Средневзвешенная температура прямой СВ за п/с]",*/

	CAST(U08_UM21F001_S1 as decimal(15,2)) as "M ОСВ за п/с, т/cут [hint: масса теплоносителя по обратным трубопроводам (счетчик)]",
	...
	/*CAST(U08_UM21T002_S1 as decimal(15,2)) as "Tср.взв. ОСВ за п/с, °С [hint: Средневзвешенная температура обратной СВ за п/с]",*/
	/*U08_VB00T001_S1,*/
	CAST(U08_UM11W001_S1 as decimal(15,2)) as "Q ПСВ за п/с, ГДж [hint: Отпущенная теплоэнергия по подающему трубопроводу (счетчик)]",
	CAST(U08_UM21W001_S1 as decimal(15,2)) as "Q ОСВ за п/с, ГДж [hint: Возвращенная теплоэнергия по обратному трубопроводу (счетчик)]",
	CAST(U08_UM31W001_S1 as decimal(15,2)) as "dQ по МАГ за п/с, ГДж [hint: Потребленная теплоэнергия (счетчик)]",
	CAST(U08_VB00T001_S1 as decimal(15,2)) as "Tхв за п/с, °С [U08_VB01T001_S1]",
