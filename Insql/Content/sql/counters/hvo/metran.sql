...
SELECT
	...
	CAST(AVG(H14_KK1F001) as decimal(15,5)) as "AVG<br>Q<br>конд.осн. [H14_KK1F001]",
	CAST(AVG(H14_KK1F002) as decimal(15,5)) as "AVG<br>Q<br>конд.дубл. [H14_KK1F002]",
	...
	null,
	CAST(AVG(H15_VE1F001) as decimal(15,5)) as "AVG<br>Q<br>ПТ1_осн. [H15_VE1F001]",
	CAST(AVG(H15_VE1F002) as decimal(15,5)) as "AVG<br>Q<br>ПТ1_дубл. [H15_VE1F002]",
	CAST(AVG(H15_VE1F003) as decimal(15,5)) as "AVG<br>Q<br>ПТ2-1_осн. [H15_VE1F003]",
	CAST(AVG(H15_VE1F004) as decimal(15,5)) as "AVG<br>Q<br>ПТ2-1_дубл. [H15_VE1F004]",
	CAST(AVG(H15_VE1F005) as decimal(15,5)) as "AVG<br>Q<br>ПТ2-2_осн. [H15_VE1F005]",
	CAST(AVG(H15_VE1F006) as decimal(15,5)) as "AVG<br>Q<br>ПТ2-2_дубл. [H15_VE1F006]",
