...
SELECT
	...
	ROUND(isnull(U10_UN11P001, 0), 2) as "Избыт. давление пара, КПа [U10_UN11P001]",
...
SELECT
	...
	ROUND(isnull(U10_UN11P001_H1, 0), 2) as "Среднее избыт. давление пара за п/ч, кПа [U10_UN11P001_H1]",
...
SELECT
	...
	ROUND(isnull(U10_UN11P001_S1, 0), 2) as "Среднее избыт. давление пара за п/с, кПа [U10_UN11P001_S1]",
...
SELECT
	...
	CAST(isnull(U10_UN11P001_H1, 0) as decimal(15, 2)) as "Среднее избыт. давление пара за п/ч, кПа [U10_UN11P001_H1]",
...
SELECT
	...
	CAST(AVG(isnull(U10_UN11P001_H1, 0)) as decimal(15, 2)) as "Среднее избыт. давление пара за смену, кПа [U10_UN11P001_H1]",
...
SELECT
	...
	CAST(AVG(isnull(U10_UN11P001_H1, 0)) as decimal(15, 2)) as "Среднее избыт. давление пара, кПа [U10_UN11P001_H1]",
