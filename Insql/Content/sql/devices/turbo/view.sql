...
SELECT
	...
	CAST(S3_UM02T002 as decimal(15,2)) as "Т сет-й воды на вых. из конд Нитка №1, °С [S3_UM02T002]",
	null,
...
SELECT
	...
	CAST(AVG(S3_UM02T002) as decimal(15,2)) as "Т сет-й воды на вых. из конд Нитка №1, °С [S3_UM02T002]",
	null,
