...
SELECT
	...
	CAST(S2_STKER_BK1 as decimal(15, 3)) as "Т обм. стат, паз № 2 [S2_STKER_BK1]",
	CAST(S2_STKER_BK7 as decimal(15, 3)) as "Т обм. стат, паз № 2 [S2_STKER_BK7]",
	CAST(S2_STKER_BK2 as decimal(15, 3)) as "Т обм. стат, паз № 3 [S2_STKER_BK2]",
	CAST(S2_STKER_BK8 as decimal(15, 3)) as "Т обм. стат, паз № 3 [S2_STKER_BK8]",
	CAST(S2_STKER_BK3 as decimal(15, 3)) as "Т обм. стат, паз № 18 [S2_STKER_BK3]",
	CAST(S2_STKER_BK9 as decimal(15, 3)) as "Т обм. стат, паз № 18 [S2_STKER_BK9]",
	CAST(S2_STKER_BK10 as decimal(15, 3)) as "Т обм. стат, паз № 19 [S2_STKER_BK10]",
	CAST(S2_STKER_BK4 as decimal(15, 3)) as "Т обм. стат, паз № 19 [S2_STKER_BK4]",
	CAST(S2_STKER_BK11 as decimal(15, 3)) as "Т обм. стат, паз № 34 [S2_STKER_BK11]",
	CAST(S2_STKER_BK5 as decimal(15, 3)) as "Т обм. стат, паз № 34 [S2_STKER_BK5]",
	CAST(S2_STKER_BK12 as decimal(15, 3)) as "Т обм. стат, паз № 35 [S2_STKER_BK12]",
	CAST(S2_STKER_BK6 as decimal(15, 3)) as "Т обм. стат, паз № 35 [S2_STKER_BK6]",
	CAST(S2_STKER_BK13 as decimal(15, 3)) as "Т. стали серд. стат., п № 2 [S2_STKER_BK13]",
	CAST(S2_STKER_BK14 as decimal(15, 3)) as "Т. стали серд. стат., п № 3 [S2_STKER_BK14]",
	CAST(S2_STKER_BK15 as decimal(15, 3)) as "Т. стали серд. стат., п № 18 [S2_STKER_BK15]",
	CAST(S2_STKER_BK16 as decimal(15, 3)) as "Т. стали серд. стат., п № 19 [S2_STKER_BK16]",
	CAST(S2_STKER_BK17 as decimal(15, 3)) as "Т. стали серд. стат., п № 34 [S2_STKER_BK17]",
	CAST(S2_STKER_BK18 as decimal(15, 3)) as "Т. стали серд. стат., п № 35 [S2_STKER_BK18]",
	...
	CAST(S2_STKER_BK31 as decimal(15, 3)) as "Т г.в.всл.патр.на вых.из возд-ля г., ст.В сп. [S2_STKER_BK31]",
	CAST(S2_STKER_BK32 as decimal(15, 3)) as "Т г.в.всл.патр.на вых.из возд-ля г., ст.В сп. [S2_STKER_BK32]",
	CAST(S2_STKER_BK33 as decimal(15, 3)) as "Т г.в.всл.патр.на вых.из возд-ля г., ст.Т сл. [S2_STKER_BK33]",
	CAST(S2_STKER_BK34 as decimal(15, 3)) as "Т г.в.всл.патр.на вых.из возд-ля г., ст.Т сл. [S2_STKER_BK34]",
