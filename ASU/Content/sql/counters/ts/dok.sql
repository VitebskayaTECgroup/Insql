...
SELECT
	...
	CAST(U06_UM21F001_H1*dbo.vst_SafeDIV(U00_UM20F702_H1,U00_UM20F701_H1) as decimal(15,0)) as "корр G ОСВ1 за п/ч, т/ч [U06_UM21F001_H1]",
	...
	CAST(U06_UM22F001_H1*dbo.vst_SafeDIV(U00_UM20F702_H1,U00_UM20F701_H1) as decimal(15,0)) as "корр G ОСВ2 за п/ч, т/ч [U06_UM22F001_H1]",
	...
	CAST(isnull(U06_UM21W002_H1,0) as decimal(15,0)) as "корр W ПСВ2 за п/ч, ГКал",
	CAST(U06_UM22W001_H1 as decimal(15,0)) as "W ОСВ2 за п/ч, ГДж [U06_UM22W001_H1]",
	CAST(isnull(U06_UM22W002_H1,0) as decimal(15,0)) as "корр W ОСВ1 за п/ч, ГКал",
