{часовые срезы}
/*ReportName=ТС "Западная" (срезы на конец часа) тест*/
/*Mode=часовые-1*/
...
select
	...
	null,
	CAST(U05_UM11F001_H1 as decimal(15,2)) as "G ПСВ за п/ч, т/час [U05_UM11F001_H1]",
	...
	CAST(U05_UM21F001_H1 as decimal(15,2)) as "G ОСВ за п/ч, т/час [U05_UM21F001_H1]",
	...
	CAST(U05_UM11W001_H1 as decimal(15,2)) as "W ПСВ за п/ч, ГДж [U05_UM11W001_H1]",
	CAST(U05_UM21W001_H1 as decimal(15,2)) as "W ОСВ за п/ч, ГДж [U05_UM21W001_H1]",
	CAST(U05_UM31W001_H1 as decimal(15,2)) as "dW по МАГ за п/ч, ГДж [U05_UM31W001_H1]",
	CAST(U05_VB00T001 as decimal(15,2)) as "Tхв за п/ч, °С [U05_VB00T001]",

	ZkorrPr as "кор Mсум ПСВ, тонн [hint: Масса теплоносителя по подающему трубопроводу скорректир]",
	ZkorrObr as "кор Mсум ОСВ, тонн [hint: Масса теплоносителя по обратному трубопроводу скорректир]",
	ZPodpKorr as "кор Mсум подп, тонн [hint: Масса теплоносителя на подпитку скорректир]",
	cast(ZEnergPr/1000 as decimal(15,2)) as "кор Qсум ПСВ, ГДж [hint:Отпущенная теплоэнергия по подающим трубопроводам скоррект]",
	cast(ZEnrgObr/1000 as decimal(15,2)) as "кор Qсум ОСВ, ГДж [hint: Отпущенная теплоэнергия по обратным трубопроводам скоррект]",
	cast(ZEnergPodp/1000 as decimal(15,2)) as "кор Qсум подп, ГДж [hint: Отпущенная теплоэнергия с подпиткой скоррект]",
	ZEnergItog as "кор dQсум,ГДж [hint: Суммарная потребленная теплоэнергия по магистралям скоррект]",
	cast(ZEnergItog/4.187 as decimal(15,0)) as "кор dQсум,Гкал [hint: Суммарная потребленная теплоэнергия по магистралям скоррект]"
from
(
select
...
cast(u04_um11w001_H1/dbo.Zero(u04_um11F001_H1)*1000/1+U04_VB00T001 as decimal(15,2)) as CEntPr,
cast(u05_um11w001_H1/dbo.Zero(u05_um11F001_H1)*1000/1+U05_VB00T001 as decimal(15,2)) as ZEntPr,
cast(u07_um11w001_H1/dbo.Zero(u07_um11G001_H1)*1000/1+U07_VB00T001 as decimal(15,2)) as MEntPr,
cast(u08_um11w001_H1/dbo.Zero(u08_um11F001_H1)*1000/1+U08_VB00T001 as decimal(15,2)) as LEntPr,
cast(u06_um11w001_H1/dbo.Zero(u06_um11F001_H1)*1000/1+U06_VB00T001 as decimal(15,2)) as DEntPr,
/*энтальпии обратной*/
cast(u04_um21w001_H1/dbo.Zero(u04_um21F001_H1)*1000/1+U04_VB00T001 as decimal(15,2)) as CEntObr,
cast(u05_um21w001_H1/dbo.Zero(u05_um21F001_H1)*1000/1+U05_VB00T001 as decimal(15,2)) as ZEntObr,
cast(u07_um21w001_H1/dbo.Zero(u07_um21G001_H1)*1000/1+U07_VB00T001 as decimal(15,2)) as MEntObr,
cast(u08_um21w001_H1/dbo.Zero(u08_um21F001_H1)*1000/1+U08_VB00T001 as decimal(15,2)) as LEntObr,
cast(u06_um21w001_H1/dbo.Zero(u06_um21F001_H1)*1000/1+U06_VB00T001 as decimal(15,2)) as DEntObr1,
cast(u06_um22w001_H1/dbo.Zero(u06_um22F001_H1)*1000/1+U06_VB00T001 as decimal(15,2)) as DEntObr2,
/*поправки для энтальпии прямой*/
(u04_um11w001_H1/dbo.Zero(u04_um11F001_H1)*1000/1+U04_VB00T001)-U04_UM11T001_H1 as CpoprPr,
(u05_um11w001_H1/dbo.Zero(u05_um11F001_H1)*1000/1+U05_VB00T001)-U05_UM11T001_H1 as ZpoprPr,
(u07_um11w001_H1/dbo.Zero(u07_um11G001_H1)*1000/1+U07_VB00T001)-U07_UM11T001_H1 as MpoprPr,
(u08_um11w001_H1/dbo.Zero(u08_um11F001_H1)*1000/1+U08_VB00T001)-U08_UM11T001_H1 as LpoprPr,
(u06_um11w001_H1/dbo.Zero(u06_um11F001_H1)*1000/1+U06_VB00T001)-U06_UM11T001_H1 as DpoprPr,
/*поправки для энтальпии обратной*/
(u04_um21w001_H1/dbo.Zero(u04_um21F001_H1)*1000/1+U04_VB00T001)-U04_UM21T001_H1 as CpoprObr,
(u05_um21w001_H1/dbo.Zero(u05_um21F001_H1)*1000/1+U05_VB00T001)-U05_UM21T001_H1 as ZpoprObr,
(u07_um21w001_H1/dbo.Zero(u07_um21G001_H1)*1000/1+U07_VB00T001)-U07_UM21T001_H1 as MpoprObr,
(u08_um21w001_H1/dbo.Zero(u08_um21F001_H1)*1000/1+U08_VB00T001)-U08_UM21T001_H1 as LpoprObr,
(u06_um21w001_H1/dbo.Zero(u06_um21F001_H1)*1000/1+U06_VB00T001)-U06_UM21T001_H1 as DpoprObr1,
(u06_um22w001_H1/dbo.Zero(u06_um22F001_H1)*1000/1+U06_VB00T001)-U06_UM22T001_H1 as DpoprObr2,
...
/*для прямой*/
cast(U04_UM11F001_H1+cast(koefNb*U04_UM11F001_H1*U04_UM11F401/100 as decimal(15,2)) as decimal (15,0))*cast(u04_um11w001_H1/dbo.Zero(u04_um11F001_H1)*1000/1+U04_VB00T001 as decimal(15,2)) as CEnergPr,
cast(U05_UM11F001_H1+cast(koefNb*U05_UM11F001_H1*U05_UM11F401/100 as decimal(15,2)) as decimal (15,0))*cast(u05_um11w001_H1/dbo.Zero(u05_um11F001_H1)*1000/1+U05_VB00T001 as decimal(15,2)) as ZEnergPr,
cast(U07_UM11G001_H1+cast(koefNb*U07_UM11G001_H1*U07_UM11F401/100 as decimal(15,2)) as decimal (15,0))*cast(u07_um11w001_H1/dbo.Zero(u07_um11G001_H1)*1000/1+U07_VB00T001 as decimal(15,2)) as MEnergPr,
cast(U08_UM11F001_H1+cast(koefNb*U08_UM11F001_H1*U08_UM11F401/100 as decimal (15,2)) as decimal (15,0))*cast(u08_um11w001_H1/dbo.Zero(u08_um11F001_H1)*1000/1+U08_VB00T001 as decimal(15,2)) as LEnergPr,
cast(U06_UM11F001_H1+cast(koefNb*U06_UM11F001_H1*U06_UM11F401/100 as decimal (15,2)) as decimal (15,0))*cast(u06_um11w001_H1/dbo.Zero(u06_um11F001_H1)*1000/1+U06_VB00T001 as decimal(15,2)) as DenergPr,
/*сумма прямых энергий*/
cast(U04_UM11F001_H1+cast(koefNb*U04_UM11F001_H1*U04_UM11F401/100 as decimal(15,2)) as decimal (15,0))*cast(u04_um11w001_H1/dbo.Zero(u04_um11F001_H1)*1000/1+U04_VB00T001 as decimal(15,2))+
cast(U05_UM11F001_H1+cast(koefNb*U05_UM11F001_H1*U05_UM11F401/100 as decimal(15,2)) as decimal (15,0))*cast(u05_um11w001_H1/dbo.Zero(u05_um11F001_H1)*1000/1+U05_VB00T001 as decimal(15,2))+
cast(U07_UM11G001_H1+cast(koefNb*U07_UM11G001_H1*U07_UM11F401/100 as decimal(15,2)) as decimal (15,0))*cast(u07_um11w001_H1/dbo.Zero(u07_um11G001_H1)*1000/1+U07_VB00T001 as decimal(15,2))+
cast(U08_UM11F001_H1+cast(koefNb*U08_UM11F001_H1*U08_UM11F401/100 as decimal (15,2)) as decimal (15,0))*cast(u08_um11w001_H1/dbo.Zero(u08_um11F001_H1)*1000/1+U08_VB00T001 as decimal(15,2))+
cast(U06_UM11F001_H1+cast(koefNb*U06_UM11F001_H1*U06_UM11F401/100 as decimal (15,2)) as decimal (15,0))*cast(u06_um11w001_H1/dbo.Zero(u06_um11F001_H1)*1000/1+U06_VB00T001 as decimal(15,2))
as SumEnerPr,
/*для обратной*/
cast(U04_UM21F001_H1-cast(koefNb*U04_UM21F001_H1*U04_UM21F401/100 as decimal(15,2)) as decimal (15,0))*cast(u04_um21w001_H1/dbo.Zero(u04_um21F001_H1)*1000/1+U04_VB00T001 as decimal(15,2)) as CenergObr,
cast(U05_UM21F001_H1-cast(koefNb*U05_UM21F001_H1*U05_UM21F401/100 as decimal(15,2)) as decimal (15,0))*cast(u05_um21w001_H1/dbo.Zero(u05_um21F001_H1)*1000/1+U05_VB00T001 as decimal(15,2)) as ZenrgObr,
cast(U07_UM21G001_H1-cast(koefNb*U07_UM21G001_H1*U07_UM21F401/100 as decimal (15,2)) as decimal (15,0))*cast(u07_um21w001_H1/dbo.Zero(u07_um21G001_H1)*1000/1+U07_VB00T001 as decimal(15,2)) as MenergObr,
cast(U08_UM21F001_H1-cast(koefNb*U08_UM21F001_H1*U08_UM21F401/100 as decimal (15,2)) as decimal (15,0))*cast(u08_um21w001_H1/dbo.Zero(u08_um21F001_H1)*1000/1+U08_VB00T001 as decimal(15,2)) as LenergObr,
cast(U06_UM21F001_H1-cast(koefNb*U06_UM21F001_H1*U06_UM21F401/100 as decimal (15,2)) as decimal (15,0))*cast(u06_um21w001_H1/dbo.Zero(u06_um21F001_H1)*1000/1+U06_VB00T001 as decimal(15,2)) as DenergObr1,
cast(U06_UM22F001_H1-cast(koefNb*U06_UM22F001_H1*U06_UM22F401/100 as decimal (15,2)) as decimal (15,0))*cast(u06_um22w001_H1/dbo.Zero(u06_um22F001_H1)*1000/1+U06_VB00T001 as decimal(15,2)) as Denergobr2,

/*сумма обратных энергий*/
cast(U04_UM21F001_H1-cast(koefNb*U04_UM21F001_H1*U04_UM21F401/100 as decimal(15,2)) as decimal (15,0))*cast(u04_um21w001_H1/dbo.Zero(u04_um21F001_H1)*1000/1+U04_VB00T001 as decimal(15,2)) +
cast(U05_UM21F001_H1-cast(koefNb*U05_UM21F001_H1*U05_UM21F401/100 as decimal(15,2)) as decimal (15,0))*cast(u05_um21w001_H1/dbo.Zero(u05_um21F001_H1)*1000/1+U05_VB00T001 as decimal(15,2)) +
cast(U07_UM21G001_H1-cast(koefNb*U07_UM21G001_H1*U07_UM21F401/100 as decimal (15,2)) as decimal (15,0))*cast(u07_um21w001_H1/dbo.Zero(u07_um21G001_H1)*1000/1+U07_VB00T001 as decimal(15,2)) +
cast(U08_UM21F001_H1-cast(koefNb*U08_UM21F001_H1*U08_UM21F401/100 as decimal (15,2)) as decimal (15,0))*cast(u08_um21w001_H1/dbo.Zero(u08_um21F001_H1)*1000/1+U08_VB00T001 as decimal(15,2)) +
cast(U06_UM21F001_H1-cast(koefNb*U06_UM21F001_H1*U06_UM21F401/100 as decimal (15,2)) as decimal (15,0))*cast(u06_um21w001_H1/dbo.Zero(u06_um21F001_H1)*1000/1+U06_VB00T001 as decimal(15,2)) +
cast(U06_UM22F001_H1-cast(koefNb*U06_UM22F001_H1*U06_UM22F401/100 as decimal (15,2)) as decimal (15,0))*cast(u06_um22w001_H1/dbo.Zero(u06_um22F001_H1)*1000/1+U06_VB00T001 as decimal(15,2))
as SumObrEnerg,
...
cast(((cast(U04_UM11F001_H1+cast(koefNb*U04_UM11F001_H1*U04_UM11F401/100 as decimal(15,2)) as decimal (15,0))*cast(u04_um11w001_H1/dbo.Zero(u04_um11F001_H1)*1000/1+U04_VB00T001 as decimal(15,2)))-
(cast(U04_UM21F001_H1-cast(koefNb*U04_UM21F001_H1*U04_UM21F401/100 as decimal(15,2)) as decimal (15,0))*cast(u04_um21w001_H1/dbo.Zero(u04_um21F001_H1)*1000/1+U04_VB00T001 as decimal(15,2)))-
...
cast((cast(U05_UM11F001_H1+cast(koefNb*U05_UM11F001_H1*U05_UM11F401/100 as decimal(15,2)) as decimal (15,0))*cast(u05_um11w001_H1/dbo.Zero(u05_um11F001_H1)*1000/1+U05_VB00T001 as decimal(15,2))-
cast(U05_UM21F001_H1-cast(koefNb*U05_UM21F001_H1*U05_UM21F401/100 as decimal(15,2)) as decimal (15,0))*cast(u05_um21w001_H1/dbo.Zero(u05_um21F001_H1)*1000/1+U05_VB00T001 as decimal(15,2))-
...
cast((cast(U07_UM11G001_H1+cast(koefNb*U07_UM11G001_H1*U07_UM11F401/100 as decimal(15,2)) as decimal (15,0))*cast(u07_um11w001_H1/dbo.Zero(u07_um11G001_H1)*1000/1+U07_VB00T001 as decimal(15,2))-
cast(U07_UM21G001_H1-cast(koefNb*U07_UM21G001_H1*U07_UM21F401/100 as decimal (15,2)) as decimal (15,0))*cast(u07_um21w001_H1/dbo.Zero(u07_um21G001_H1)*1000/1+U07_VB00T001 as decimal(15,2))-
...
cast((cast(U08_UM11F001_H1+cast(koefNb*U08_UM11F001_H1*U08_UM11F401/100 as decimal (15,2)) as decimal (15,0))*cast(u08_um11w001_H1/dbo.Zero(u08_um11F001_H1)*1000/1+U08_VB00T001 as decimal(15,2))-
cast(U08_UM21F001_H1-cast(koefNb*U08_UM21F001_H1*U08_UM21F401/100 as decimal (15,2)) as decimal (15,0))*cast(u08_um21w001_H1/dbo.Zero(u08_um21F001_H1)*1000/1+U08_VB00T001 as decimal(15,2))-
...
/1000 as decimal(15,0)) as DenergItog
...
U08_UM11F001_H1,U08_UM21W002_H1,U08_UM21F001_H1,U08_UM31W001_H1,U08_UM11W001_H1, U08_UM21W001_H1, U08_UM21T001_H1,
U04_UM11T001_H1, U06_UM11T001_H1, U07_UM11T001_H1, U05_UM11T001_H1,U08_UM11T001_H1,  U04_UM41T001_H1, U04_VB00T001,U05_VB00T001,U07_VB00T001,U08_VB00T001,U06_VB00T001,
 U06_UM21T001_H1, U06_UM22T001_H1, U07_UM21T001_H1, U05_UM21T001_H1,
...
select
	...
	CAST(U05_UM11F001_S1 as decimal(15,2)) as "M ПСВ за п/с, т/cут [hint:  масса  теплоносителя по подающим трубопроводам (счетчик)]",
	...
	CAST(U05_UM11T002_S1 as decimal(15,2)) as "Tср.взв. ПСВ за п/с, °С [hint: Средневзвешенная температура прямой СВ за п/с]",

	CAST(U05_UM21F001_S1 as decimal(15,2)) as "M ОСВ за п/с, т/cут [hint:  масса теплоносителя по обратным трубопроводам (счетчик)]",
	...
	CAST(U05_UM21T002_S1 as decimal(15,2)) as "Tср.взв. ОСВ за п/с, °С [hint: Средневзвешенная температура обратной СВ за п/с]",

	CAST(U05_UM11W001_S1 as decimal(15,2)) as "Q ПСВ за п/с, ГДж [hint: Отпущенная  теплоэнергия по подающему трубопроводу (счетчик)]",
	CAST(U05_UM21W001_S1 as decimal(15,2)) as "Q ОСВ за п/с, ГДж [hint: Возвращенная теплоэнергия по обратному трубопроводу (счетчик)]",
	CAST(U05_UM31W001_S1 as decimal(15,2)) as "dQ по МАГ за п/с, ГДж [hint: Потребленная теплоэнергия  (счетчик)]",
