...
SELECT
	...
	CAST(U02_UN12P001*U02_SY00A700 as decimal(15,2)) as "P Пар28, изб.МПа [U02_UN12P001]",
...
SELECT
	...
	CAST(U02_UN11P001_H1 as decimal(15,2)) as "P Пар18 за п/ч, изб.МПа [U02_UN11P001_H1]",
	...
	CAST(U02_UN12P001_H1 as decimal(15,2)) as "P Пар28 за п/ч, изб.МПа [U02_UN12P001_H1]",
...
SELECT
	...
	CAST(U02_UN11P001_S1 as decimal(15,2)) as "P Пар18 за п/ч, изб.МПа [U02_UN11P001_S1]",
	...
	CAST(U02_UN12P001_S1 as decimal(15,2)) as "P Пар28 за п/ч, изб.МПа [U02_UN12P001_S1]",
...
SELECT
	...
	CAST(AVG(U02_UN11P001_H1) as decimal(15,2)) as "P Пар18 ср, изб.МПа [U02_UN11P001_H1]",
	...
	CAST(AVG(U02_UN12P001_H1) as decimal(15,2)) as "P Пар28 ср, изб.МПа [U02_UN12P001_H1]",
