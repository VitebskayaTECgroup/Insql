{срезы минутные}
/*ReportName="Отчёт КА-3 VG1. Экран 3" (срезы минутные)*/
/*Mode=минутные*/
...
{срезы на конец часа}
/*ReportName="Отчёт КА-3 VG1. Экран 3" (срезы на конец часа)*/
/*Mode=часовые-1*/
...
/*ReportName="Отчёт КА-3 VG1. Экран 3" (срезы на конец суток)*/
/*Mode=суточные-1*/
...
/*ReportName="Отчёт КА-3 VG1. Экран 3" (агрегированные за час)*/
/*Mode=часовые-2*/
...
/*ReportName="Отчёт КА-3 VG1. Экран 3" (агрегированные за сутки)*/
/*Mode=суточные-2*/
