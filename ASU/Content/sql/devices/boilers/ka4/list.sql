...
SELECT
	DateTime as "Дата",
	null,
	CAST(K4_Ppar as decimal(15, 1)) as "Ppar<br>Рп, МПа [K4_Ppar]",
	CAST(K4_Pwater as decimal(15, 1)) as "Pwater<br>Рпв, МПа [K4_Pwater]",
	CAST(K4_VG1_P25b as decimal(15, 1)) as "П25б<br>Тп, °С [K4_VG1_P25b]",
	CAST(K4_Gper_par as decimal(15, 1)) as "Gper_par<br>Gп, тонн [K4_Gper_par]",
	CAST(K4_VG1_P13b as decimal(15, 1)) as "П13б<br>tпв до котла, °C [K4_VG1_P13b]",
	CAST(K4_Gpit_wat as decimal(15, 1)) as "Gpit_wat<br>Gпв, тонн [K4_Gpit_wat]",
...
SELECT
	...
	null,
	CAST(AVG(K4_Ppar) as decimal(15, 1)) as "Ppar<br>Рп, МПа [K4_Ppar]",
	CAST(AVG(K4_Pwater) as decimal(15, 1)) as "Pwater<br>Рпв, МПа [K4_Pwater]",
	CAST(AVG(K4_VG1_P25b) as decimal(15, 1)) as "П25б<br>Тп, °С [K4_VG1_P25b]",
	CAST(AVG(K4_Gper_par) as decimal(15, 1)) as "Gper_par<br>Gп, тонн [K4_Gper_par]",
	CAST(AVG(K4_VG1_P13b) as decimal(15, 1)) as "П13б<br>tпв до котла, °C [K4_VG1_P13b]",
	CAST(AVG(K4_Gpit_wat) as decimal(15, 1)) as "Gpit_wat<br>Gпв, тонн [K4_Gpit_wat]",
...
FROM (
	SELECT
		...
		CAST(K4_Ppar as decimal(15, 1)) as "K4_Ppar",
		CAST(K4_Pwater as decimal(15, 1)) as "K4_Pwater",
		CAST(K4_VG1_P25b as decimal(15, 1)) as "K4_VG1_P25b",
		CAST(K4_Gper_par as decimal(15, 1)) as "K4_Gper_par",
		CAST(K4_VG1_P13b as decimal(15, 1)) as "K4_VG1_P13b",
		CAST(K4_Gpit_wat as decimal(15, 1)) as "K4_Gpit_wat",
