...
SELECT
	...
	CAST(K4_Gper_par as decimal(15, 0)) as "Gper_par<br>Gп, тонн [K4_Gper_par]",
	CAST(K4_VG1_P13b as decimal(15, 1)) as "П13б<br>tпв до котла, °C [K4_VG1_P13b]",
	CAST(K4_Gpit_wat as decimal(15, 0)) as "Gpit_wat<br>Gпв, тонн [K4_Gpit_wat]",
...
SELECT
	...
	CAST(AVG(K4_Gper_par) as decimal(15, 0)) as "Gper_par<br>Gп, тонн [K4_Gper_par]",
	CAST(AVG(K4_VG1_P13b) as decimal(15, 1)) as "П13б<br>tпв до котла, °C [K4_VG1_P13b]",
	CAST(AVG(K4_Gpit_wat) as decimal(15, 0)) as "Gpit_wat<br>Gпв, тонн [K4_Gpit_wat]",
...
FROM (
	SELECT
		...
		CAST(K4_Gper_par as decimal(15, 0)) as "K4_Gper_par",
		CAST(K4_VG1_P13b as decimal(15, 1)) as "K4_VG1_P13b",
		CAST(K4_Gpit_wat as decimal(15, 0)) as "K4_Gpit_wat",
