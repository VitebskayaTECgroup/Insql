...
SELECT
	...
	CAST (S2_MV001_a1 as decimal(15,3)) as "Осевая вибрация п.п. 1 [S2_MV001_a1]",
	CAST (S2_MV002_a2 as decimal(15,3)) as "Поперечная вибрация п.п. [S2_MV002_a2]",
	CAST (S2_MV003_a3 as decimal(15,3)) as "Осевая вибрация п.п. 2 [S2_MV003_a3]",
	CAST (S2_MV004_S1_1 as decimal(15,3)) as "Осевой сдвиг ротора 1 [S2_MV004_S1_1]",
	CAST (S2_MV005_S1_2 as decimal(15,3)) as "Осевой сдвиг ротора 2 [S2_MV005_S1_2]",
	CAST (S2_MV006_S1_3 as decimal(15,3)) as "Осевой сдвиг ротора 3 [S2_MV006_S1_3]",
	CAST (S2_MV007_a4 as decimal(15,3)) as "Вертикальная вибрация з.п. 1 [S2_MV007_a4]",
	CAST (S2_MV008_a5 as decimal(15,3)) as "Поперечная вибрация з.п. 1 [S2_MV008_a5]",
	CAST (S2_MV009_a6 as decimal(15,3)) as "Осевая вибрация з.п. [S2_MV009_a6]",
	CAST (S2_MV011_a7 as decimal(15,3)) as "Вертикальная вибрация з.п. 2 [S2_MV011_a7]",
	CAST (S2_MV012_a8 as decimal(15,3)) as "Поперечная вибрация з.п. 2 [S2_MV012_a8]",
	CAST (S2_MV014_S2 as decimal(15,3)) as "Относительное тепловое расширение ротора [S2_MV014_S2]",
	CAST (S2_MV015_S2 as decimal(15,3)) as "Относительное тепловое расширение цилиндра 1 [S2_MV015_S2]",
	CAST (S2_MV015_S3 as decimal(15,3)) as "Относительное тепловое расширение цилиндра 2 [S2_MV015_S3]",
