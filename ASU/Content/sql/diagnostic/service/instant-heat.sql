...
SELECT
	...
	CAST(U04_UM11G002 as decimal(6,3)) as "G ПСВ Центр дубл [U04_UM11G002]",
	null,
	CAST(U04_UM41G001 as decimal(6,2)) as "G Подп [U04_UM41G001]",
	CAST(U04_UM41G002 as decimal(6,3)) as "G Подп дубл [U04_UM41G002]",
	null,
	CAST(U05_UM11G001 as decimal(6,2)) as "G ПСВ Запад [U05_UM11G001]",
	CAST(U05_UM11G002 as decimal(6,3)) as "G ПСВ Запад дубл [U05_UM11G002]",
	null,
	CAST(U05_UM21G001 as decimal(6,2)) as "G ОСВ Запад [U05_UM21G001]",
	CAST(U05_UM21G002 as decimal(6,3)) as "G ОСВ Запад дубл [U05_UM21G002]",
	null, 
	CAST(U06_UM11G001 as decimal(6,2)) as "G ПСВ ДОК [U06_UM11G001]",
	CAST(U06_UM11G002 as decimal(6,3)) as "G ПСВ ДОК дубл [U06_UM11G002]",
	null,
	CAST(U06_UM21G001 as decimal(6,2)) as "G ОСВ1 ДОК [U06_UM21G001]",
	CAST(U06_UM21G002 as decimal(6,3)) as "G ОСВ1 ДОК дубл [U06_UM21G002]",
	null,
	CAST(U06_UM22G001 as decimal(6,2)) as "G ОСВ2 ДОК [U06_UM22G001]",
	CAST(U06_UM22G002 as decimal(6,3)) as "G ОСВ2 ДОК дубл [U06_UM22G002]",
	null,
	CAST(U07_UM11G001 as decimal(6,2)) as "G ПСВ ВЗРД [U07_UM11G001]",
	CAST(U07_UM11G002 as decimal(6,3)) as "G ПСВ ВЗРД дубл [U07_UM11G002]",
	null,
	CAST(U07_UM21G001 as decimal(6,2)) as "G ОСВ ВЗРД [U07_UM21G001]",
	CAST(U07_UM21G002 as decimal(6,3)) as "G ОСВ ВЗРД дубл [U07_UM21G002]"
FROM
	OpenQuery(INSQL,
